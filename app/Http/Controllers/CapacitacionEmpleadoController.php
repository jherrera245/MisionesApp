...
class CapacitacionEmpleadoController extends Controller
{
    ...
    public function store(CapacitacionEmpleadoRequest $request)
    {
        ...
        $inscripcion->comprobante_inscripcion = CapacitacionEmpleadoController::guadarArchivoEnServidor($request, 'inscripcion',"Comprobante-de-inscripcion-");
        $inscripcion->comprobante_finalizacion = CapacitacionEmpleadoController::guadarArchivoEnServidor($request, 'finalizacion',"Comprobante-de-finalizacion-");
