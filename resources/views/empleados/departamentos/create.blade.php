...
<div class="card shadow mb-4">
    ...
    <a href="#collapseCardDepartamento" class="d-block card-header py-3" data-toggle="collapse" role="button"
        ...
        <h6 class="m-0 font-weight-bold text-primary">Registro de departamentos</h6>
    </a>
    ...
    <div class="collapse show" id="collapseCardDepartamento">
        <div class="card-body">
            ...
            <form action="/departamentos" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6 col-xs-12 mb-3">
                        <label for="nombre" class="form-label">Nombre</label>
                        <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingresa el nombre del Departamento" maxlength="70" required>
                    </div>
                </div>
