    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardUsuario">
                <div class="card-body">
                    <h5>Perfil de: {{$empleados->nombres}} {{$empleados->apellidos}}</h5>
